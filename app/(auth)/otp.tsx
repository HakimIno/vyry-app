...
import { verifyOtp, requestOtp } from '@/features/auth/auth-api';
            ...
            >
                <View style={[styles.body, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 16 }]}>
                    ...
                    <View style={styles.header}>
                        ...
                        <ThemedText style={[styles.phoneNumber, { color: '#FFFFFF' }]}>
                            {formatPhone(phone ?? '')}
                        </ThemedText>
                        {/* Form */}
                        ...
                        <View style={styles.resendContainer}>
                            {countdown > 0 ? (
                                <ThemedText style={[styles.resendText, isDark && styles.resendTextDark]}>
